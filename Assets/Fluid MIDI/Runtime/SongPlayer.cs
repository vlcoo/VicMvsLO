...
namespace FluidMidi
{
    public class SongPlayer : MonoBehaviour
    {
        ...
        public int Ticks
        {
            get { return playerPtr != IntPtr.Zero ? Api.Player.GetCurrentTick(playerPtr) : 0; }
        }
        ...
        public bool IsPlaying
        {
            get
            {
                return IsPaused || (playerPtr != IntPtr.Zero &&
        ...
        public bool IsDone
        {
            get { return unloadDelay >= 0 && !IsPlaying; }
        }
