...
namespace Quantum {
    ...
    public unsafe partial struct FrameEvents {
      ...
      static partial void GetEventTypeCodeGen(Int32 eventID, ref System.Type result) {
        switch (eventID) {
          ...
          case EventMarioGoalFinishedSliding.ID: result = typeof(EventMarioGoalFinishedSliding); return;
          case EventFlagpoleStateChanged.ID: result = typeof(EventFlagpoleStateChanged); return;
      ...
      public EventMarioTouchedGoal MarioTouchedGoal(Frame Frame, EntityRef Entity, MarioPlayer Mario) {
        if (_f.IsPredicted) return null;
      ...
      public EventMarioGoalFinishedSliding MarioGoalFinishedSliding(Frame Frame, EntityRef Entity, MarioPlayer Mario) {
        if (_f.IsPredicted) return null;
        var ev = _f.Context.AcquireEvent<EventMarioGoalFinishedSliding>(EventMarioGoalFinishedSliding.ID);
        ev.Frame = Frame;
        ev.Entity = Entity;
        ev.Mario = Mario;
        _f.AddEvent(ev);
      ...
      public EventFlagpoleStateChanged FlagpoleStateChanged(Frame Frame, FlagpoleState NewState) {
        if (_f.IsPredicted) return null;
        var ev = _f.Context.AcquireEvent<EventFlagpoleStateChanged>(EventFlagpoleStateChanged.ID);
        ev.Frame = Frame;
        ev.NewState = NewState;
        _f.AddEvent(ev);
        return ev;
  ...
  public unsafe partial class EventMarioGoalFinishedSliding : EventBase {
    public new const Int32 ID = 35;
    public Frame Frame;
    public EntityRef Entity;
    public MarioPlayer Mario;
    protected EventMarioGoalFinishedSliding(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventMarioGoalFinishedSliding() : 
  ...
  public unsafe partial class EventFlagpoleStateChanged : EventBase {
    public new const Int32 ID = 36;
    public Frame Frame;
    public FlagpoleState NewState;
    protected EventFlagpoleStateChanged(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventFlagpoleStateChanged() : 
