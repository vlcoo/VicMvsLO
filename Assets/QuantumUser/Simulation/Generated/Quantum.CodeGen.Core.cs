...
namespace Quantum {
  ...
  public enum GoalAnimationState : byte {
    Grabbed,
    StartSliding,
    FinishSliding,
    Celebration,
  ...
  public unsafe partial struct GameRules {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + ScoreEnabled.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        QBoolean.Serialize(&p->ScoreEnabled, serializer);
  ...
  public unsafe partial struct MarioPlayer : Quantum.IComponent {
    ...
    [FieldOffset(8)]
    [ExcludeFromPrototype()]
    public Byte FlagpoleAnimationFrames;
    [FieldOffset(19)]
    [ExcludeFromPrototype()]
    ...
    [FieldOffset(216)]
    [ExcludeFromPrototype()]
    public EntityRef CurrentFlagpole;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 5503;
        ...
        hash = hash * 31 + Disconnected.GetHashCode();
        hash = hash * 31 + IsDead.GetHashCode();
        hash = hash * 31 + HasCheckpoint.GetHashCode();
        ...
        hash = hash * 31 + FlagpoleAnimationFrames.GetHashCode();
        ...
        hash = hash * 31 + CurrentFlagpole.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        serializer.Stream.Serialize(&p->FlagpoleAnimationFrames);
        ...
        QBoolean.Serialize(&p->HasCheckpoint, serializer);
        ...
        EntityRef.Serialize(&p->CurrentFlagpole, serializer);
  ...
  public unsafe partial class Frame {
    ...
    public unsafe partial struct FrameSignals {
      ...
      public void OnMarioPlayerFinishedFlagpoleAnimation(EntityRef entity) {
        var array = _f._ISignalOnMarioPlayerFinishedFlagpoleAnimationSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
      ...
      public void OnMarioPlayerGotCheckpoint(EntityRef entity) {
        var array = _f._ISignalOnMarioPlayerGotCheckpointSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.GoalAnimationState), 1);
    ...
    public static void EnsureNotStrippedGen() {
      ...
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.GoalAnimationState>();
