...
namespace Quantum.Prototypes {
  ...
  public unsafe partial class GameRulesPrototype : StructPrototype {
    ...
    public void Materialize(Frame frame, ref Quantum.GameRules result, in PrototypeMaterializationContext context = default) {
        ...
        result.PMushroom = this.PMushroom;
        result.PFireFlower = this.PFireFlower;
        result.PIceFlower = this.PIceFlower;
        result.PPropellerMushroom = this.PPropellerMushroom;
        result.PBlueShell = this.PBlueShell;
        result.PHammerSuit = this.PHammerSuit;
        result.PMiniMushroom = this.PMiniMushroom;
        result.PMegaMushroom = this.PMegaMushroom;
        result.PStarman = this.PStarman;
