...
namespace Photon.Realtime
{
    ...
    /// <summary>
    ///     This static class defines some useful extension methods for several existing classes (e.g. Vector3, float and
    ///     others).
    /// </summary>
    public static class Extensions
    {
        ...
        /// <remarks>
        ///     By making keysWithNullValue a static variable to clear before using, allocations only happen during the warm-up
        ///     phase
        ///     as the list needs to grow. Once it hit the high water mark for keys you need to remove.
        /// </remarks>
        private static readonly System.Collections.Generic.List<object> keysWithNullValue = new();
        ...
        {
            if (addHash == null || target.Equals(addHash)) return;

            foreach (var key in addHash.Keys) target[key] = addHash[key];
        }
