...
namespace Photon.Pun.UtilityScripts
{
        ...
        , IMatchmakingCallbacks
    {
        ...
        public virtual void OnJoinedRoom()
        {
            ...
            if (AutoSpawnObjects && !PhotonNetwork.LocalPlayer.HasRejoined) SpawnObjects();
        }
        ...
        public virtual void SpawnObjects()
        {
            if (PrefabsToInstantiate != null)
                foreach (var o in PrefabsToInstantiate)
                {
                    ...
                    var newobj = PhotonNetwork.Instantiate(o.name, spawnPos, spawnRot);
        ...
        /// <summary>
        ///     Gets the next SpawnPoint from the list using the SpawnSequence, and applies RandomOffset (if used) to the transform
        ///     matrix.
        ...
        ///     Override this method to change how Spawn Point transform is selected. Return the transform you want to use as a
        ///     spawn point.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        ///     When UseRandomeOffset is enabled, this method is called to produce a Vector3 offset. The default implementation
        ///     clamps the Y value to zero. You may override this with your own implementation.
        /// </summary>
        ...
        /// <summary>
        ///     Validate, and if valid add this prefab to the first null element of the list, or create a new element. Returns true
        ...
        protected static GameObject ValidatePrefab(GameObject unvalidated)
        {
            ...
            if (unvalidated != null)
            {
                ...
                if (isValidPrefab)
                    validated = PrefabUtility.GetCorrespondingObjectFromSource(unvalidated);
                else
                    return null;
    ...
    public class OnJoinedInstantiateEditor : Editor
    {
        ...
        public void EditableReferenceList(SerializedProperty list, GUIContent gc, GUIStyle style = null)
        {
            ...
            if (count == 0)
            {
                if (GUI.Button(EditorGUILayout.GetControlRect(GUILayout.MaxWidth(20)), "+", "minibutton"))
                {
            ...
            else
            {
                ...
                for (var i = 0; i < count; ++i)
                {
                    ...
                    var add = GUI.Button(EditorGUILayout.GetControlRect(GUILayout.MaxWidth(20)), "+", "minibutton");
                    EditorGUILayout.PropertyField(list.GetArrayElementAtIndex(i), GUIContent.none);
                    var remove = GUI.Button(EditorGUILayout.GetControlRect(GUILayout.MaxWidth(20)), "x", "minibutton");
                ...
                if (GUI.Button(EditorGUILayout.GetControlRect(), "Add", "minibutton"))
                    Add(list, count);
            }
