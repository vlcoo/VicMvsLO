...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class PunTurnManager : MonoBehaviourPunCallbacks, IOnEventCallback
    {
        ...
        public float ElapsedTimeInTurn =>
            (PhotonNetwork.ServerTimestamp - PhotonNetwork.CurrentRoom.GetTurnStart()) / 1000.0f;
        ...
        public bool IsCompletedByAll => PhotonNetwork.CurrentRoom != null && Turn > 0 &&
                                        finishedPlayers.Count == PhotonNetwork.CurrentRoom.PlayerCount;
        ...
        /// <summary>
        ///     Gets a value indicating whether the current turn is over. That is the ElapsedTimeinTurn is greater or equal to the
        ///     TurnDuration
        /// </summary>
        ...
        ///     The move object can be anything. Try to optimize though and only send the strict minimum set of information to
        ///     define the turn move.
        /// </summary>
        ...
        public void SendMove(object move, bool finished)
        {
            ...
            if (finished) PhotonNetwork.LocalPlayer.SetFinishedTurn(Turn);
        ...
        {
            if (player != null && finishedPlayers != null && finishedPlayers.Contains(player)) return true;
        ...
        private void ProcessOnEvent(byte eventCode, object content, int senderId)
        {
            ...
            switch (eventCode)
            {
                ...
                case EvFinalMove:
                {
                    ...
                    if (IsCompletedByAll) TurnManagerListener.OnTurnCompleted(Turn);
                    break;
                }
            }
        }
    ...
    public static class TurnExtensions
    {
        ...
        public static void SetTurn(this Room room, int turn, bool setStartTime = false)
        {
            ...
            if (setStartTime) turnProps[TurnStartPropKey] = PhotonNetwork.ServerTimestamp;
        ...
        public static int GetTurn(this RoomInfo room)
        {
            if (room == null || room.CustomProperties == null ||
                !room.CustomProperties.ContainsKey(TurnPropKey)) return 0;
        ...
        {
            if (room == null || room.CustomProperties == null ||
                !room.CustomProperties.ContainsKey(TurnStartPropKey)) return 0;
