...
namespace Photon.Pun
{
    ...
    {
        /// <summary>
        ///     Called by PUN several times per second, so that your script can write and read synchronization data for the
        ///     PhotonView.
        /// </summary>
        /// <remarks>
        ...
        ///     Unlike other callbacks,
        ///     <i>
        ///         OnPhotonSerializeView only gets called when it is assigned
        ///         to a PhotonView
        ///     </i>
        ///     as PhotonView.observed script.
    ...
    /// <summary>
    ///     Global Callback interface for ownership changes. These callbacks will fire for changes to ANY PhotonView that
    ///     changes.
    ...
    public interface IPunPrefabPool
    {
        ...
        /// <summary>
        ///     Called to destroy (or just return) the instance of a prefab. It's disabled and the pool may reset and cache it for
        ///     later use in Instantiate.
        /// </summary>
        /// <remarks>
