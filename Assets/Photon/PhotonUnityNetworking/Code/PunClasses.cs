...
namespace Photon.Pun
{
    ...
    public class MonoBehaviourPun : MonoBehaviour
    {
        ...
        public PhotonView photonView
        {
            get
            {
                ...
                if (!Application.isPlaying || pvCache == null) pvCache = PhotonView.Get(this);
#else
    ...
    /// <summary>
    ///     This class provides a .photonView and all callbacks/events that PUN can call. Override the events/methods you want
    ///     to use.
    /// </summary>
    /// <remarks>
        ...
        IInRoomCallbacks, ILobbyCallbacks, IWebRpcCallback, IErrorInfoCallback
    {
        ...
        /// </summary>
        /// <remarks>
        ///     The most common cause to fail creating a room, is when a title relies on fixed room-names and the room already
        ///     exists.
        /// </remarks>
    ...
    public struct PhotonMessageInfo
    {
        ...
        public double timestamp
        {
            get
            {
                var u = (uint)SentServerTimestamp;
                double t = u;
                return t / 1000.0d;
            }
        }
        ...
        public int SentServerTimestamp { get; }
    ...
    /// <summary>
    ///     This container is used in OnPhotonSerializeView() to either provide incoming data of a PhotonView or for you to
    ///     provide it.
    /// </summary>
    /// <remarks>
    ...
    ///     Use either Serialize() for reading and writing or SendNext() and ReceiveNext(). The latter two are just explicit
    ///     read and
    ...
    public class PhotonStream
    {
        ...
        public PhotonStream(bool write, object[] incomingData)
        {
            ...
            if (!write && incomingData != null) readData = incomingData;
        }
    ...
    /// <summary>
    ///     The default implementation of a PrefabPool for PUN, which actually Instantiates and Destroys GameObjects but pools
    ///     a resource.
    /// </summary>
    /// <remarks>
    ...
    public class DefaultPool : IPunPrefabPool
    {
        ...
        {
            GameObject res = null;
            var cached = ResourceCache.TryGetValue(prefabId, out res);
            if (!cached)
            {
            ...
            var instance = Object.Instantiate(res, position, rotation);
