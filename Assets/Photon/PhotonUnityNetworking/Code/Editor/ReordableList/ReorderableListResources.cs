...
namespace Photon.Pun
{
    ...
    internal static class ReorderableListResources
    {
        ...
        /// </summary>
        public static Texture2D texAddButton => s_Cached[(int)ResourceName.add_button];

        /// <summary>
        ///     Gets light or dark texture "add_button_active.png".
        /// </summary>
        public static Texture2D texAddButtonActive => s_Cached[(int)ResourceName.add_button_active];

        /// <summary>
        ///     Gets light or dark texture "container_background.png".
        /// </summary>
        public static Texture2D texContainerBackground => s_Cached[(int)ResourceName.container_background];

        /// <summary>
        ///     Gets light or dark texture "grab_handle.png".
        /// </summary>
        public static Texture2D texGrabHandle => s_Cached[(int)ResourceName.grab_handle];

        /// <summary>
        ///     Gets light or dark texture "remove_button.png".
        /// </summary>
        public static Texture2D texRemoveButton => s_Cached[(int)ResourceName.remove_button];

        /// <summary>
        ///     Gets light or dark texture "remove_button_active.png".
        /// </summary>
        public static Texture2D texRemoveButtonActive => s_Cached[(int)ResourceName.remove_button_active];

        /// <summary>
        ///     Gets light or dark texture "title_background.png".
        /// </summary>
        public static Texture2D texTitleBackground => s_Cached[(int)ResourceName.title_background];
        ...
        private static readonly GUIStyle s_TempStyle = new();
