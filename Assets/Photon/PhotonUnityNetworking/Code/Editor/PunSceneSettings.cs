...
#pragma warning disable 0414
        [SerializeField] private bool SceneSettingsListFoldoutOpen = true;
#pragma warning restore 0414
#endif

        [SerializeField] public List<SceneSetting> MinViewIdPerScene = new();

        public static string PunSceneSettingsCsPath
        {
            get
            {
                if (!string.IsNullOrEmpty(punSceneSettingsCsPath)) return punSceneSettingsCsPath;
