...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        /// <summary>
        ///     The maximum number of assigned PhotonViews <i>per player</i> (or scene). See the [General Documentation](@ref
        ///     general) topic "Limitations" on how to raise this limitation.
        /// </summary>
        public static readonly int MAX_VIEW_IDS = 500; // VIEW & PLAYER LIMIT CAN BE EASILY CHANGED, SEE DOCS
        ...
        ///     PhotonNetwork.ConnectUsingSettings will call either ConnectToMaster, ConnectToRegion or ConnectToBest, depending on
        ///     the settings.
        /// </remarks>
        ...
        ///     a PhotonView's OnSerialize/ObservingComponent.
        /// </summary>
        /// <remarks>
        ///     Note that this is the sqrMagnitude. E.g. to send only after a 0.01 change on the Y-axix, we use
        ///     0.01f*0.01f=0.0001f. As a remedy against float inaccuracy we use 0.000099f instead of 0.0001f.
        /// </remarks>
        public static float PrecisionForVectorSynchronization = 0.000099f;

        /// <summary>
        ///     The minimum angle that a rotation needs to change before we send it via a PhotonView's
        ///     OnSerialize/ObservingComponent.
        /// </summary>
        ...
        ///     PUN can automatically dispatch messages in LateUpdate for low timeScale values (when Time.timeScale is lower than
        ///     this value).
        ...
        ///     If Instantiate is called from FixedUpdate, the physics engine seems to run for instantiated objects before the
        ///     engine calls Start() on them.
        ...
        private static int
            lastUsedViewSubId; // each player only needs to remember it's own (!) last used subId to speed up assignment

        private static int
            lastUsedViewSubIdStatic; // per room, the master is able to instantiate GOs. the subId for this must be unique too
        ...
        /// <summary>
        ///     Version number of your game. Setting this updates the AppVersion, which separates your playerbase in
        ///     matchmaking.
        /// </summary>
        /// <remarks>
        ...
        ///     This means you can set the GameVersion right after calling ConnectUsingSettings (e.g.) and the new value will be
        ///     used on the server.
        ...
        /// <remarks>
        ///     Sent with the operation Authenticate. When using PUN, you should set the GameVersion or use
        ...
        /// <summary>
        ///     Currently used Cloud Region (if any). As long as the client is not on a Master Server or Game Server, the
        ///     region is not yet defined.
        /// </summary>
        ...
        /// <summary>
        ///     False until you connected to Photon initially. True immediately after Connect-call, in offline mode, while
        ///     connected to any server and even while switching servers.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     A refined version of connected which is true only if your connection to the server is ready to accept operations
        ///     like join, leave, etc.
        /// </summary>
        ...
        ///     While OfflineMode is true, this is ClientState.Joined (after create/join) or ConnectedToMasterServer in all other
        ///     cases.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        ///     LoadBalancing Client is not aware of the Photon Offline Mode, so never use
        ///     PhotonNetwork.NetworkingClient.CurrentRoom will be null if you are using OffLine Mode, while
        ...
        /// <summary>
        ///     Set to synchronize the player's nickname with everyone in the room(s) you enter. This sets
        ...
        /// <summary>
        ///     A sorted copy of the players-list of the current room. This is using Linq, so better cache this value. Update when
        ///     players join / leave.
        /// </summary>
        ...
        /// <summary>
        ///     A sorted copy of the players-list of the current room, excluding this client. This is using Linq, so better cache
        ///     this value. Update when players join / leave.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        ///     It's best practice to disconnect inactive apps/connections after a while but to also allow users to take calls,
        ///     etc..
        ...
        ///     Use PhotonNetwork.PlayerList.Length or PhotonNetwork.CurrentRoom.PlayerCount to get the count of players in the
        ///     room you're in!
        /// </summary>
        ...
        /// <summary>
        ///     Defines the number of times a reliable message can be resent before not getting an ACK for it will trigger a
        ...
        /// <summary>
        ///     Defines overrides for server ports. Used per server-type if > 0. Important: If you change the transport
        ///     protocol, adjust the overrides, too.
        /// </summary>
        ...
        ///     - etc.
        ///     In general check out the <see cref="DisconnectCause" /> from the <see cref="IConnectionCallbacks.OnDisconnected" />
        ///     callback.
        /// </remarks>
        ...
        ///     This call can take up to 2 seconds if it is the first time you are using this, all cloud servers will be pinged to
        ///     check for the best region.
        ...
        /// </remarks>
        /// <returns>
        ///     If this client is going to connect to cloud server based on ping. Even if true, this does not guarantee a
        ///     connection but the attempt is being made.
        /// </returns>
        ...
        /// <summary>
        ///     Makes this client disconnect from the photon server, a process that leaves any room and calls OnDisconnected on
        ///     completion.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     Helper function which is called inside this class to erify if certain functions can be used (e.g. RPC when not
        ///     connected)
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        ///     Can be used to immediately send the RPCs and Instantiates just called, so they are on their way to the other
        ///     players.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     Request a client to disconnect/kick, which happens if EnableCloseConnection is set to true. Only the master
        ///     client can do this.
        /// </summary>
        ...
        public static bool CloseConnection(Player kickPlayer)
        {
            ...
            var options = new RaiseEventOptions { TargetActors = new[] { kickPlayer.ActorNumber } };
        ...
        ///     If the current Master Client leaves, PUN will detect a new one by "lowest player ID". Implement
        ...
        ///     Filters for rooms that match these custom properties (string keys and
        ///     values). To ignore, pass null.
        /// </param>
        ...
        /// <param name="typedLobby">
        ///     The lobby in which you want to lookup a room. Pass null, to use the default lobby. This does
        ///     not join that lobby and neither sets the lobby property.
        /// </param>
        /// <param name="sqlLobbyFilter">A filter-string for SQL-typed lobbies.</param>
        /// <param name="expectedUsers">
        ///     Optional list of users (by UserId) who are expected to join this game and who you want to
        ///     block a slot for.
        /// </param>
        /// <returns>If the operation got queued and will be sent.</returns>
        public static bool JoinRandomRoom(Hashtable expectedCustomRoomProperties, byte expectedMaxPlayers,
        ...
        /// </summary>
        /// <remarks>
        ///     When successful, this calls the callbacks OnCreatedRoom and OnJoinedRoom (the latter, cause you join as first
        ///     player).
        ...
        ///     Common options for the room like MaxPlayers, initial custom room properties and similar. See
        ///     RoomOptions type..
        /// </param>
        /// <param name="typedLobby">
        ///     If null, the room is automatically created in the currently used lobby (which is "default"
        ///     when you didn't join one explicitly).
        /// </param>
        /// <param name="expectedUsers">
        ///     Optional list of users (by UserId) who are expected to join this game and who you want to
        ///     block a slot for.
        ...
        ///     If the room was shut down in the meantime, PUN will call OnJoinRoomFailed and return this client to the Master
        ///     Server.
        ...
        /// </remarks>
        /// <returns>
        ///     False, if there is no known room or game server to return to. Then, this client does not attempt the
        ///     ReconnectAndRejoin.
        /// </returns>
        ...
        /// <summary>
        ///     Internally used helper-method to setup an offline room, the numbers for actor and master-client and to do the
        ///     callbacks.
        /// </summary>
        ...
        /// <summary>
        ///     Fetches a custom list of games from the server, matching a (non-empty) SQL-like filter. Triggers
        ...
        ///     Only string-typed keys will be used from this hashtable. If null, custom properties are
        ///     all deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        ///     Locally removes Custom Properties of "this" player. Important: This does not synchronize the change! Useful when
        ///     you switch rooms.
        /// </summary>
        /// <remarks>
        ...
        ///     If customPropertiesToDelete is null or has 0 entries, all Custom Properties are deleted (replaced with a new
        ///     Hashtable).
        ...
        ///     A byte identifying the type of event. You might want to use a code per action or to signal
        ///     which content can be expected. Allowed: 0..199.
        /// </param>
        /// <param name="eventContent">
        ///     Some serializable object like string, byte, integer, float (etc) and arrays of those.
        ///     Hashtables with byte keys are good to send variable content.
        /// </param>
        /// <param name="raiseEventOptions">
        ///     Allows more complex usage of events. If null, RaiseEventOptions.Default will be used
        ///     (which is fine).
        /// </param>
        ...
        public static bool AllocateViewID(PhotonView view)
        {
            ...
            {
                Debug.LogError(
                    "AllocateViewID() can't be used for PhotonViews that already have a viewID. This view is: " + view);
                return false;
            }
        ...
        /// </summary>
        /// <returns>
        ///     True if a viewId was assigned. False if the PhotonView already had a non-zero viewID or if this client is not
        ///     the Master Client.
        /// </returns>
            ...
            object[] data = null)
        {
            ...
            return NetworkInstantiate(netParams);
        }
        ...
        /// <summary>
        ///     Network-Destroy all GameObjects, PhotonViews and their RPCs in the room. Removes anything buffered from the server.
        ...
        /// <summary>
        ///     Remove all buffered RPCs from server that were sent by targetPlayer. Can only be called on local player (for
        ///     "self") or Master Client (for anyone).
        /// </summary>
        /// <remarks>
        ...
        public static HashSet<GameObject> FindGameObjectsWithComponent(Type type)
        {
            ...
            var targetComponents = (Component[])Object.FindObjectsOfType(type);
        ...
        /// <summary>
        ///     Finds the asset path base on its name or search query:
        ...
        {
            var photonHandlers = Object.FindObjectsOfType(typeof(PhotonHandler)) as PhotonHandler[];
