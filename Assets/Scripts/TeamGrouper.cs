...
public class TeamGrouper : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        foreach (var character in GlobalController.Instance.characters)
    ...
    public void PlayerGotStar(PlayerController whom)
    {
        ...
        foreach (var teammate in teams[whom.character.prefab].Where(controller => !controller.Equals(whom)))
