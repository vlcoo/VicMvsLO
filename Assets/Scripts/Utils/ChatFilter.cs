...
namespace NSMB.Utils
{
    ...
    {
        private static readonly string FILTER_BASE64 =
            "";
        ...
        public static string FilterString(string input)
        {
            ...
            var filteredInput = input.ToLower();
            ...
            foreach (var word in filteredWords)
            {
                ...
                {
                    var mainCapture = match.Captures[0];
        ...
        {
            foreach (var (replace, replacement) in REPLACEMENTS)
